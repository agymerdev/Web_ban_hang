...
namespace WebBanHangOnline.Models
{
    ...
    public partial class WebBanHangOnlineEntities : DbContext
    {
        public WebBanHangOnlineEntities()
            : base("name=WebBanHangOnlineEntities")
        {
        }
        ...
        public virtual ObjectResult<sp_ThongKe_Result> sp_ThongKe()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_ThongKe_Result>("sp_ThongKe");
        }
    }
}
